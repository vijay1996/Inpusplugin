...
class Inpus_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'foo_widget', // Base ID
			esc_html__( 'Inpus Plugin', 'inpus_domain' ), // Name
			array( 'description' => esc_html__( 'An Simple User plugin', 'inpus_domain' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Inpus', 'inpus_domain' );
		?>
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>">
            <?php esc_attr_e( 'Title:', 'inpus_domain' ); ?>
        </label> 
		<input 
            class="widefat" 
